...
class ApiClient {
  ...
  /**
   * Fund Milestone (Multi-Release)
   */
  async fundMilestone(contractId, signer, milestoneIndex, amount, secretKey, verbose = false) {
    const payload = {
      contractId,
      signer,
      milestoneIndex: String(milestoneIndex),
    ...
    const endpoint = '/escrow/multi-release/fund-escrow';
